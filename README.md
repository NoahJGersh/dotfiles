...
Additionally, I would love to figure out a declarative, if impure, installation process that allows me to provide my own FoundryVTT credentials to grab the build I want from the website.
